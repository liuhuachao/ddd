...
namespace WebApi.Repository
{
    public class PigeonsContext : DbContext
    {
        ...
        public virtual DbSet<Model.HomeList> HomeList { get; set; }
        public virtual DbSet<Model.HomeDetail> HomeDetail { get; set; }
        public virtual DbSet<Model.HomeSearch> HomeSearch { get; set; }
        public virtual DbSet<Model.HotSearch> HotSearch { get; set; }
